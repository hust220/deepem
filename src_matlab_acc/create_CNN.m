...
ran1=shuffle(size(positive1,3),100*size(positive1,3));
...
if(do_train_again)
    ran2=shuffle(size(positive2,3), 100*size(positive2, 3));
...
ran3=shuffle(size(negative1,3), 100*size(negative1, 3));
...
if(do_train_again)
    ran4=shuffle(size(negative2,3), 100*size(negative2, 3));
