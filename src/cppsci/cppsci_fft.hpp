...
/**
 * Fast fourier transformation of N-dimension array.
 */
template<typename T, typename V>
void fft(T in, V out, STD_ vector<int> dims, int direct = -1) {
    int nd = dims.size();
    int *v = new int[nd];
    for (int i = 0; i < nd; i++) v[i] = dims[i];
    fftw_plan plan = fftw_plan_dft(nd, v, reinterpret_cast<fftw_complex*>(in), reinterpret_cast<fftw_complex*>(out), direct, FFTW_ESTIMATE);
    delete [] v;
    fftw_execute(plan);
...
/**
 * Fast fourier transformation of 1D array.
 */
template<typename T, typename V>
...
/**
 * Fast fourier transformation of 2D array.
 */
template<typename T, typename V>
...
/**
 * Fast fourier transformation of 3D array.
 */
template<typename T, typename V>
...
/**
 * Inverse fast fourier transformation of N-dimension array.
 */
template<typename T, typename V>
void ifft(T in, V out, STD_ vector<int> dims) {
    fft(in, out, dims, 1);
    int k = 1;
...
/**
 * Inverse fast fourier transformation of 1D array.
 */
template<typename T, typename V>
...
/**
 * Inverse fast fourier transformation of 2D array.
 */
template<typename T, typename V>
...
/**
 * Inverse fast fourier transformation of 3D array.
 */
template<typename T, typename V>
...
/**
 * Shift of fast fourier transformation of N-dimension array.
 */
template<typename T, typename V>
...
/**
 * Shift of fast fourier transformation of 1D array.
 */
template<typename T, typename V>
...
/**
 * Shift of fast fourier transformation of 2D array.
 */
template<typename T, typename V>
...
/**
 * Shift of fast fourier transformation of 3D array.
 */
template<typename T, typename V>
